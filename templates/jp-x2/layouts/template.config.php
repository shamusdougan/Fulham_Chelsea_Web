...
// Logo Height
$css[] = sprintf('#header{ height: %dpx;}', $this['config']->get('logo-height'));
...
$this['asset']->addFile('css', 'css:widgetkit.css');
...
if (($menustyle = $this['config']->get('menustyle')) && $this['path']->path("css:/menustyle/$menustyle.css")) { $this['asset']->addFile('css', "css:/menustyle/$menustyle.css"); }
if (($bgoverlay = $this['config']->get('bgoverlay')) && $this['path']->path("css:/bg-overlay/$bgoverlay.css")) { $this['asset']->addFile('css', "css:/bg-overlay/$bgoverlay.css"); }
