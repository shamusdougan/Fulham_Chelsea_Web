...
<h1 class='title'>Send us an Email</h1>
<div id="sp_quickcontact<?php echo $uniqid ?>" class="sp_quickcontact">
	...
	<form id="sp-quickcontact-form">
		...
		<div class="sp_qc_clr"></div>
		<textarea name="message" id="message" onfocus="if (this.value=='<?php echo $msg_text ?>') this.value='';" onblur="if (this.value=='') this.value='<?php echo $msg_text ?>';" style='width: 100%' rows=""><?php echo $msg_text ?></textarea>	
		<div class="sp_qc_clr"></div>
		<?php if($formcaptcha) { ?>
